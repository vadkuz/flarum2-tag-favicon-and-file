...
- Автоопределение favicon по домену: `flarum.org` или `https://flarum.org`
...
- Кнопка в админке для принудительного обновления кэша favicon у конкретного тега
...
- Automatic favicon detection by domain: `flarum.org` or `https://flarum.org`
...
- Admin button to force refresh favicon cache for a specific tag
